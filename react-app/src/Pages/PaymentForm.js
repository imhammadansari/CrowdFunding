...
const PaymentForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`https://funding-platform.up.railway.app/payments/pay/${id}`, {
                requestId: id,
                donorName,
                donorEmail,
                donorPhone,
            ...
            await axios.post(`https://funding-platform.up.railway.app/requests/updateStatus/${id}`, {
                status: 'Paid',
            });
        } catch (error) {
