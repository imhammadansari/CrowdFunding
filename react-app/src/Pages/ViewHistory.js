...
const ViewHistory = () => {
        ...
        const fetchFundingRequests = async () => {
            try {
                const response = await axios.get(
                    `https://crowdfunding-5ttm.onrender.com/requests/userRequests/${userId}`, 
    ...
    if (loading) {
        return <div className="p-6 bg-gray-100 min-h-screen flex justify-center items-center">Loading...</div>;
    }
        ...
        <div className="p-6 bg-gray-100 min-h-screen">
            ...
            {fundingRequests.length === 0 ? (
                <div className="text-center bg-white p-8 rounded-lg shadow-lg">
                    <p className="text-xl text-gray-600">No funding requests found.</p>
                    <button
