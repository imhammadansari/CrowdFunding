...
const ViewHistoryRequest = () => {
    ...
    return (
        <div className="p-6 bg-gray-100 min-h-screen">
            <h1 className="text-3xl font-bold text-center text-gray-800 mb-8">View Request Details</h1>
            <div className="bg-white rounded-lg shadow-lg p-6 max-w-4xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <p className="text-gray-700"><strong>ID:</strong> {request._id}</p>
                    </div>
                    <div>
...
export default ViewHistoryRequest;